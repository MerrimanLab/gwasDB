...
purrr::map_dfr(b37_files, vroom, col_types = c("ccncc") ) %>% vroom::vroom_write(path = "/tmp/tmp_b37.csv",delim = ',')
```
...
purrr::map_dfr(marker_files, vroom, col_types = c("cc") ) %>% vroom::vroom_write(path = "/tmp/tmp_marker.csv"),delim = ',')
```
